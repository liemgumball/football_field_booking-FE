...
const AvailableBookings = () => {
	...
	return (
		<main>
			...
			<AvailabilityForm className="container mx-auto my-10 grid grid-cols-1 justify-items-center rounded-2xl bg-popover px-4 pb-6 pt-10 md:grid-cols-2 xl:grid-cols-5" />
			<section className="container px-12">
				<FetchErrorHandler isError={isError} errorMsg={error?.message}>
					<ul className="grid grid-cols-1 items-stretch justify-items-center gap-x-6 gap-y-12 transition-all duration-1000 lg:grid-cols-2 xl:grid-cols-3">
